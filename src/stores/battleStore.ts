...
interface BattleStoreState {
  ...
  // Actions
  startBattle: (playerDeck: Card[], enemyProfileId: string, overrideProfile?: EnemyProfile, decayStage?: number, activeCorruptions?: string[]) => void;
  doMulligan: () => void;
  acceptHand: () => void;
...
export const useBattleStore = create<BattleStoreState>((set, get) => ({
  ...
  startBattle: (playerDeck, enemyProfileId, overrideProfile, decayStage = 0, activeCorruptions: string[] = []) => {
